...
|------|--------|------|-----------|
| unit01 Agent Core | oc01-oc11 | 11 个 | L1-L5 |
| unit02 Prompt Eng | oc12-oc17 | 6 个 | L1-L5 |
| unit03 多 Agent | oc18-oc25 | 8 个 | L1-L5 |
| unit04 状态记忆 | oc26-oc32 | 7 个 | L1-L5 |
| **总计** | — | **32 个** | — |
...
| M3 | 新增 MCP 工具 | unit01 |
| M4 | 可观测性增强 | unit01 |
| M5 | Prompt 注入链理解 | unit02 |
| M6 | Persona Prompt 改好 | unit02 |
| M7 | Harness 编排流程图 | unit03 |
| M8 | Harness 审计 + 改进 | unit03 |
| M9 | Handoff 超时修复 | unit03 |
| M10 | Memory 架构理解 | unit04 |
| M11 | Memory 审计 + 改进 | unit04 |
