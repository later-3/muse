...
| 来源 | 章节 | 覆盖深度 | 关键贡献 |
|------|------|---------|---------|
| [learn-claude-code](../../repos/learn-claude-code/docs/en/s01-the-agent-loop.md) | s01-s12 全部 | ⭐⭐⭐ | 渐进式教学 + 完整代码 |
| [ai-agents-for-beginners](../../repos/ai-agents-for-beginners/07-planning-design/README.md) | L07: Planning | ⭐⭐ | 规划设计模式 |
