...
5. **OpenCode 是贯穿线。** 每天至少 1 个 OpenCode 关联点（机制学习 / 源码拆解 / 对 Muse 的启发，三选一）。不为凑 OC 写低质量内容。
6. **双轨并行，AI 先踩坑。** 你学习的同时，AI 并行做代码验证、Bug 发现、Spike 预跑、坑点文档。你到手时路已经清过，坑已经标好，不用自己去踩。
