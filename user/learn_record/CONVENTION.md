...
| D22 | 4/29 | W4 | N10 多Agent | 吴恩达M5 + swarm + [LH26] [Agent互动](https://youtu.be/mmPmNezjCi0) + **[LH26] [Harness Engineering](https://youtu.be/R6fZR_9kmIw)** | oc18 触发Harness | — |
| D23 | 4/30 | W4 | N10 多Agent续 | [LH26] [解剖小龙虾/OpenClaw](https://youtu.be/2rcJdFuNbZQ) + LH26_06 Harness 補充 | oc19 Swarm demo | — |
| D24 | 5/1 | W4 | N05 推理优化 1/2 | [LH26] [Flash Attention](https://youtu.be/vXb2QYOUzl4) + LH26_06 Harness 工具設計 | oc20 Harness走读 | F13 开始 |
...
>
> **知识包管线：** 李宏毅课程已建立完整的 **音频→转录→知识包** 自动化管线（见 `reference/courses/TRANSCRIPT_PIPELINE.md`）。33 个知识包存放在 `reference/courses/lee-hongyi/knowledge/` 下，每篇包含 [Fact] 标记的讲师原话引用，可直接作为 learn_record 的补充资源引用。
> **Harness Engineering 知识包：** `reference/courses/lee-hongyi/knowledge/LH26_06_harness_engineering.md` — 涵盖 Harness 三维度（认知框架/能力边界/行为流程）、AGENTS.md 实证研究、工具设计原则、模型情绪实验、Life-long Agent 概念。映射 N11 Context 工程 + N10 Agent 核心。
...
- Harness Engineering: https://youtu.be/R6fZR_9kmIw
...
| Day | 目录 | 状态 | 知识包融合 |
|-----|------|------|----------|
| D01 | 0408-backpropagation/ | [AI✓] | Karpathy Micrograd |
| D02 | 0409-transformer-1/ | [AI✓] | ✅ LH21 Self-Attention × 2 + Model Inside + Transformer Encoder |
| D03 | 0410-transformer-2/ | [AI✓] | ✅ LH21 Transformer Decoder + Mamba |
| D04 | 0411-transformer-3/ | [AI✓] | Build GPT 后段 |
| D05 | 0412-training-pipeline-1/ | [AI✓] | ✅ Training Tips + Post-training + Multi-GPU + Evaluation |
| D06 | 0413-training-pipeline-2/ | [AI✓] | ✅ LH25F LLM学习历程 + RL概述 |
| D07 | 0414-review-week1/ | [AI✓] | Week 1 复习 + 面试卡片 5 道 |
| D08 | 0415-tokenization-1/ | [AI✓] | Karpathy Tokenizer |
| D09 | 0416-tokenization-2/ | [AI✓] | minbpe 走读 |
| D10 | 0417-agent-core-1/ | [AI✓] | 吴恩达 M1 + BEA + LH25 AI Agent |
| D11 | 0418-agent-core-2/ | [AI✓] | 吴恩达 M2 + Weng Blog |
| D12 | 0419-agent-core-3/ | [AI✓] | 吴恩达 M3 + BEA Tool Use |
| D13 | 0420-reasoning-1/ | [AI✓] | LH25 Reasoning + CoT 论文 |
| D14 | 0421-review-week2/ | [AI✓] | Week 2 复习 + 面试卡片 5 道 |
| D15 | 0422-reasoning-2/ | [AI✓] | LH25 Reason Eval + Reason Shorter |
| D16 | 0423-context-eng-1/ | [AI✓] | LH26 Context Engineering |
| D17 | 0424-context-eng-2/ | [AI✓] | 吴恩达 MCP 短课 |
| D18 | 0425-context-eng-3/ | [AI✓] | 吴恩达 Memory 短课 |
| D19 | 0426-rag/ | [AI✓] | RAG 設計 |
| D20 | 0427-prompt-practice/ | [AI✓] | study 04a 七层 Prompt |
| D21 | 0428-review-week3/ | [AI✓] | Week 3 复习 + 面试卡片 5 道 |
| D22 | 0429-multi-agent-1/ | [AI✓] | LH26_02b Agent 互动 + Swarm |
| D23 | 0430-multi-agent-2/ | [AI✓] | 通信 + 5 坑 + 5 框架 |
| D24 | 0501-inference-opt-1/ | [AI✓] | LH26_03 Flash Attention + KV Cache |
| D25 | 0502-inference-opt-2/ | [AI✓] | LH26_04 KV Cache |
| D26 | 0503-positional-embed/ | [AI✓] | LH26_05 Positional Embedding |
| D27 | — | 待创建 | 需要：吴恩达 Eval Agents |
| D28 | — | 待创建 | Week 4 复习 |

### Harness Engineering 融合计划

| 目标 Day | 融合内容 | 来源 |
|---------|---------|------|
| D22 补充 | Harness 三维度（认知框架/能力边界/行为流程）+ AGENTS.md 实证 | LH26_06 §二/§三 |
| D23 补充 | Meta-Harness 实验 + Life-long Agent + Auto Dream | LH26_06 §四/§五 |
| D24 补充 | 工具设计原则（ACI）+ Agent-first CLI + 模型情绪实验 | LH26_06 §三.2/§三.4 |
