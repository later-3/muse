...
// All integration tests run sequentially to avoid port conflicts
// (Node.js test runner runs top-level describes concurrently by default)
describe('T09 集成联调', { concurrency: false }, () => {
