...
运行时可通过 Family Registry 查询成员列表：
- 配置文件: `families/later-muse-family/family.json`
- 成员目录: `families/later-muse-family/members/`
```
...
| 11 | SKILL.md YAML frontmatter 有 description | 文件开头 |
| 12 | 目录结构正确 | `.agents/knowledge/` + `.agents/skills/` |
